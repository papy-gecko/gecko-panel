...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command(ProcessRunnableCommand::class)->everyMinute()->name("check-monitors")->withoutOverlapping();
        ...
        $schedule->call(function() { (new \App\Jobs\CheckMonitors())->handle(); })->everyMinute()->name("check-monitors")->withoutOverlapping();
