...
return [
    'heading' => 'Сардэчна запрашаем у Gecko!',
...
',
        ...
        'intro-first-node' => [
            ...
            'button_label' => 'Стварыце першы вузел у Gecko',
        ],
        'intro-support' => [
            'heading' => 'Падтрымка Gecko',
            'content' => 'Дзякуй за выкарыстанне Gecko! Гэта стала магчымым толькі дзякуючы падтрымцы вас, нашых удзельнікаў і ўсіх астатніх, хто нас падтрымлівае!',
