...
return [
    ...
    'sections' => [
        ...
        'intro-update-available' => [
            ...
            'button_changelog' => 'O que há de novo?',
        ],
        'intro-no-update' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Se você encontrar quaisquer problemas, por favor relate-os no GitHub.',
            'button_label' => 'Criar primeiro Node no Gecko',
        ],
        'intro-support' => [
            'heading' => 'Apoie o Gecko',
            'content' => 'Obrigado por usar o Gecko, isso só foi possível através do apoio de vocês, dos nossos colaboradores e dos nossos apoiadores!',
