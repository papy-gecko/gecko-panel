...
return [
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Si tienes algún problema, por favor repórtalo en GitHub.',
            'button_label' => 'Crear el primer node en Gecko',
        ],
        'intro-support' => [
            'heading' => 'Apoyar a Gecko',
            'content' => '¡Gracias por usar Gecko! Esto solo ha sido posible gracias a ti, nuestros colaboradores y el resto de nuestros seguidores.',
