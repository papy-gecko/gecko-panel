...
return [
    ...
    'sections' => [
        ...
        'intro-update-available' => [
            ...
            'button_changelog' => 'Co nowego?',
        ],
        'intro-no-update' => [
            'heading' => 'Twój Panel jest aktualny',
            'content' => 'Używasz Gecko w wersji :version. Twój panel jest aktualny!',
        ],
        'intro-first-node' => [
            ...
            'extra_note' => 'Jeśli napotkasz jakieś problemy, zgłoś je na GitHubie.',
            'button_label' => 'Stwórz pierwszy węzeł w Gecko',
        ],
        'intro-support' => [
            'heading' => 'Wspomóż Gecko',
            'content' => 'Dziękujemy za korzystanie z Gecko, jest to możliwe jedynie dzięki waszemu wsparciu, naszym współtwórcom i pozostałym naszym zwolennikom!',
