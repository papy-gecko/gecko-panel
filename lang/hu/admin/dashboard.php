...
return [
    ...
    'sections' => [
        ...
        'intro-update-available' => [
            ...
            'button_changelog' => 'Újdonságok',
        ],
        'intro-no-update' => [
            'heading' => 'A Panel naprakész',
            'content' => 'A Geckood :version verzióját futtatja. A paneled naprakész!',
        ],
        'intro-first-node' => [
            ...
            'extra_note' => 'Ha bármilyen problémába ütközik, kérjük jelentse a GitHubon.',
            'button_label' => 'Első csomópont létrehozása a Geckoban',
        ],
        'intro-support' => [
            'heading' => 'Gecko támogatása',
            'content' => 'Köszönjük, hogy használja a Geckot, ezt csak az Ön és a támogatóink segítségével tudtuk elérni!',
