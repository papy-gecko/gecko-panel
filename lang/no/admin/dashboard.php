...
return [
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Hvis du støter på problemer, vennligst rapporter dem på GitHub.',
            'button_label' => 'Opprett første node i Gecko',
        ],
        'intro-support' => [
            'heading' => 'Støtt Gecko',
            'content' => 'Takk for at du bruker Gecko! Dette har kun vært mulig gjennom støtten fra deg, våre bidragsytere og resten av våre støttespillere!',
